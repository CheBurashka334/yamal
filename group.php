...
<div class="group-page">
	...
	<div class="logos-block">
		...
		<div class="dividers row">
			<div class="item b-left col l6 m6 s6 offset-l6 offset-m6 offset-s6"></div>
			<div class="item b-left b-top col l3 m4 s4 offset-l3 offset-m2 offset-s2"></div>
			<div class="item b-left b-top b-right col l3 m4 s4"></div>
		</div>
		<div class="secondline-logo-box row">
			<div class="logo-item col l4 m4 s4 right-align">
				<img src="images/content/group/group-logo-micro.png" />
			</div>
			<div class="logo-item col l4 m4 s4 center-align">
				<img src="images/content/group/group-logo-garantee.png" />
			</div>
			<div class="logo-item col l4 m4 s4 left-align">
				<img src="images/content/group/group-logo-lease.png" />
			</div>
		</div>
	</div>
