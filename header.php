	...
	<div class="header">
		<div class="header-content">
			<div class="container row">
				...
				<div class="phone-box col l3 offset-l3 s8">
		...
		<div class="header-menu">
			<div class="container row">
				...
				<div class="main-menu-box hide-on-med-and-down">
					<ul class="main-menu">
						<li class="menu-item"><a class="menu-link" href="#">О Ямале</a></li>
				...
				<div class="search-box hide-on-small-only">
					<button class="btn-icon default"><svg class="icon"><use xlink:href="#magnifying-glass"/></svg></button>
